...
export default function PostsPage() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-ink-soft">Everything we publish to your Google listing.</p>
      ...
      {rows.length === 0 ? (
        <p className="mt-6 rounded-[14px] border border-dashed border-rule px-4 py-10 text-center text-[13px] leading-relaxed text-muted">
          No posts yet. The agent publishes the first one once it starts running.
        </p>
      ) : (
