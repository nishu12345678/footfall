...
/*
 * DM Sans has no Devanagari glyphs at all, so any Hindi on the page would
 * drop to whatever the OS happens to have — a different face on every
 * machine, and often a much heavier one.
 *
 ...
 * Devanagari falls through to Noto. Mixed Hinglish in one sentence comes out
 * right with no markup.
 */
