            ...
            <Reveal key={item.q} delay={Math.min(i * 40, 240)}>
              <details className="group py-1">
                <summary className="flex cursor-pointer list-none items-start gap-4 py-4 [&::-webkit-details-marker]:hidden">
                  ...
                  <span className="flex-1 font-display text-[17px] font-semibold leading-snug transition-colors group-hover:text-pin">
                    {item.q}
                  </span>
                  <span
                    aria-hidden
                    className="mt-0.5 flex-none font-mono text-[15px] text-pin transition-transform duration-200 group-open:rotate-45"
                  >
                    +
                  </span>
                </summary>
                <p className="pb-5 pl-[2.1rem] pr-8 text-[15px] leading-relaxed text-ink-soft">
                  {item.a}
                </p>
              </details>
            </Reveal>
