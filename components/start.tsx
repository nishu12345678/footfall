...
export function Start() {
  return (
    <section id="start" className="px-5 py-20 sm:py-28">
      <div className="mx-auto max-w-4xl rounded-[28px] bg-ink px-6 py-16 text-white shadow-lift sm:px-14 sm:py-20">
        <div className="mx-auto max-w-2xl text-center">
          <Reveal>
            <h2 className="text-[clamp(2.1rem,5.5vw,3.4rem)] text-white">
              Let&rsquo;s look at your listing together
            </h2>

            <p className="mx-auto mt-6 max-w-lg text-[19px] leading-relaxed text-white/70">
